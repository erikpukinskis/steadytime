...
class User
  ...
  module GeneratedAssociationMethods
    ...
    def google_account_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def google_account_ids=(ids); end

    # This method is created by ActiveRecord on the `User` class because it declared `has_many :google_accounts`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::GoogleAccount::PrivateCollectionProxy) }
    def google_accounts; end

    sig { params(value: T::Enumerable[::GoogleAccount]).void }
    def google_accounts=(value); end
  end
