...
class ActiveSupport::TestCase
  sig { params(fixture_name: NilClass, other_fixtures: NilClass).returns(T::Array[GoogleAccount]) }
  sig { params(fixture_name: T.any(String, Symbol), other_fixtures: NilClass).returns(GoogleAccount) }
  sig do
    params(
  ...
  def google_accounts(fixture_name = nil, *other_fixtures); end
